...
public class ItemServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        // Create a sample list of grocery items
        java.util.List<String> items = java.util.Arrays.asList("Apple", "Banana", "Milk", "Bread");

        // Attach the list to the request
        request.setAttribute("items", items);

        // Forward to the JSP page for display
        javax.servlet.RequestDispatcher dispatcher = request.getRequestDispatcher("items.jsp");
